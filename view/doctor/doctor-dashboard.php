...
<!-- End Sidebar-->
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                 ...
                 <?php
                  $treatmentSql = "SELECT * FROM `prescriptions` WHERE doctor_id = $adid";
                   $doctorTreatment= mysqli_query($con,$treatmentSql);
                    $treatmentCount = mysqli_num_rows($doctorTreatment);
                       $treatmentSql = "SELECT * FROM `prescriptions` WHERE doctor_id = $adid";
                ?>
                <div class="card-body">
  ...
  <?php
                  $problemSql1 = "SELECT * FROM problems WHERE doctor_id = $adid AND status = ''";
                   $problemTreatment1= mysqli_query($con,$problemSql1);
                    $problemCount1 = mysqli_num_rows($problemTreatment1);
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
               ...
               <?php
                  $problemSql = "SELECT * FROM `problems` WHERE doctor_id = $adid";
                   $problemTreatment= mysqli_query($con,$problemSql);
                    $problemCount = mysqli_num_rows($problemTreatment);
