...
try{
  ...
  //  random passowrd
   ...
   $profileSql="UPDATE `doctor_profiles` SET `mobile`='$mobile',`academic_title`='$academic_title',`specialties`='$specialist',`degree`='$degree',`collage`='$collage',`image`='$image' WHERE user_id = $user_id";
        ...
        <div class="card-body ">
           <form class="row g-3" method="POST"  enctype="multipart/form-data">
                ...
                <div class="col-12 col-lg-6">
                  ...
                  <input type="text" class="form-control" id="inputNanme2" name="collage" value="<?php echo $row['collage'] ?>">
                </div>
                 <div class="col-12 col-lg-6">
                  <label for="inputNanme3" class="form-label">Academic Title</label>
                  <input type="text" class="form-control" id="inputNanme3" name="academic_title" value="<?php echo $row['academic_title'] ?>">
                </div>
                 <div class="col-12 col-lg-6">
                  <label for="inputNanme4" class="form-label">Specialist</label>
                  <input type="text" class="form-control" id="inputNanme4" name="specialist" value="<?php echo $row['specialties'] ?>">
                </div>
                 <div class="col-12 col-lg-6">
                  <label for="inputNanme5" class="form-label">Deegree</label>
                  <input type="text" class="form-control" id="inputNanme5" name="degree" value="<?php echo $row['degree'] ?>">
                </div>
               
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Mobile</label>
                  <input type="text" class="form-control" id="inputAddress" name="mobile" value="<?php echo $row['mobile'] ?>">
                </div>
                <div class="col-12">
