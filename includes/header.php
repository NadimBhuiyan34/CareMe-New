...
// $query="select * from tbluserregistration where ID='$adid'";
if($role=='doctor')
{
     $query="SELECT *
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../../assets/profile/<?php echo $row1['image'] ?>" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $row1['fullName'] ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $row1['fullName'] ?></h6>
              <span class="badge text-bg-success"><?php echo $row1['role'] ?></span>
